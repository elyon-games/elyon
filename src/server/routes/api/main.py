...
# from server.routes.api.files import route_files
...
from server.routes.api.client import route_client
# from server.routes.api.sessions import route_sessions

route_api = Blueprint("api", __name__)

# route_api.register_blueprint(route_files, url_prefix="/files")
